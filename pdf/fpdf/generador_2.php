...
/* seleccionamos el tipo, estilo y tamaño de la letra a utilizar */
		...
		$pdf->Cell(30);
		$pdf->Write (7,'Cédula: '.$_POST['cedula']);
		$pdf->Ln();
		$pdf->Cell(30);
		...
		//La linea a continuación es para xampp, no obstante se está usan WAMP
		...
		$pdf->Ln();
		$pdf->Cell(30);
		$pdf->Write (7,'Teléfono: '.$_POST['telefono']);
		$pdf->Ln();
		$pdf->Cell(30);
		...
		$pdf->SetFont('Helvetica', 'B', 16);
		$pdf->Cell(39);
		$pdf->Cell(20,10,'Información Académica',0,1,'C'); 
		$pdf->Ln(2);
		$pdf->SetFont('Helvetica', '', 12);
		$pdf->Cell(30);
		...
		$pdf->Ln();
		$pdf->Cell(30);
		$pdf->Write (7,'Inst./Profesión: '.$_POST['instruccion_usr']);
		$pdf->Ln(); //salto de linea
		$pdf->Cell(30);
		...
		$pdf->Write (7,'Teléfono: '.$_POST['telf_ref_1']);
		$pdf->Ln(); //salto de linea
		$pdf->Cell(30);
		$pdf->Write (7,'Nombre: '.$_POST['nombre_ref_2'].'       ');
		$pdf->Write (7,'Teléfono: '.$_POST['telf_ref_2']);
		$pdf->Ln();
